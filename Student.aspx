<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student.aspx.cs" Inherits="login.Student" %>
...
<div class="animated bounceInDown">
  <div class="container">
    ...
    <form name="form1" class="box" onsubmit="return checkStuff()">
      <h4>
          <span>Student</span></h4>
      <h5>Sign up to the Account</h5>
      ...
      <span>Made with <i class="fa fa-heart pulse"></i> <a href="https://www.google.de/maps/place/Augsburger+Puppenkiste/@48.360357,10.903245,17z/data=!3m1!4b1!4m2!3m1!1s0x479e98006610a511:0x73ac6b9f80c4048f"><a href="https://codepen.io/lordgamer2354">By Republic of Government</a></span>
          ...
          // asp:TextBox ID="TextBox2" runat="server" Height="29px" Width="300px" placeholder="Enter the user national ID">//asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/images/delete.png" Width="50px" style="margin-top: 0px" OnClick="ImageButton1_Click" />
